...
for (i in 2:length(filelist)){
  naming2 <- read_delim(here("Data", "Raw", "Naming", "Logfiles", filelist[i]), delim="\t", col_names = header, locale = locale("nl"), skip = 1)
...
```{r base_model}
Logit.0 <- glmer(1 + Response_button ~ Probe_type_Base*Stimulus_type_Base*Response_type_Base +
