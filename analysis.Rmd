...
# set working directory to naming data directory
setwd("C:/Users/eirin/Documents/PhD/Classes/KPLS2020/KPLS5/Data/Raw/Naming")

# read in annotations
naming_onsets_local <- read_delim("AH_NamingOnsets.txt", delim = "\t")
...
write_compendium_description(package = "KLPS5",
                             description = "A demo of reproducible analysis for the Key Practices for the Language Scientist course, session 5")
```
